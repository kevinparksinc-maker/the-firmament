...
export const ROYAL_STARS = [
  { name: "Aldebaran", mapAngle: 45,  direction: "East",  meaning: "Watcher of the East — 15° Taurus" },
  { name: "Regulus",   mapAngle: 125, direction: "North", meaning: "Watcher of the North — 5° Leo" },
  { name: "Antares",   mapAngle: 225, direction: "West",  meaning: "Watcher of the West — 15° Scorpio" },
  { name: "Fomalhaut", mapAngle: 310, direction: "South", meaning: "Watcher of the South — 10° Aquarius" },
];
...
export const LUNAR_MANSIONS = [
  { number: 1,  name: "Al-Sharatain",  start: 0,      end: 12.857,  sign: "Aries",       meaning: "The Two Signs — beginnings, travel, new ventures" },
  { number: 2,  name: "Al-Butain",     start: 12.857, end: 25.714,  sign: "Aries",       meaning: "The Belly — hidden things, inner strength" },
  { number: 3,  name: "Al-Thurayya",   start: 25.714, end: 38.571,  sign: "Taurus",      meaning: "The Pleiades — abundance, beauty, the cluster" },
  { number: 4,  name: "Al-Dabaran",    start: 38.571, end: 51.429,  sign: "Taurus",      meaning: "The Follower — Aldebaran, power and honor" },
  { number: 5,  name: "Al-Haqa",       start: 51.429, end: 64.286,  sign: "Taurus",      meaning: "The White Spot — Orion's head, clarity" },
  { number: 6,  name: "Al-Hana",       start: 64.286, end: 77.143,  sign: "Gemini",      meaning: "The Mark — communication, twins" },
  { number: 7,  name: "Al-Dhira",      start: 77.143, end: 90.0,    sign: "Gemini",      meaning: "The Forearm — strength, reaching out" },
  { number: 8,  name: "Al-Nathrah",    start: 90.0,   end: 102.857, sign: "Cancer",      meaning: "The Gap — the Beehive cluster, nurturing" },
  { number: 9,  name: "Al-Tarf",       start: 102.857,end: 115.714, sign: "Cancer",      meaning: "The Glance — the eye, perception" },
  { number: 10, name: "Al-Jabhah",     start: 115.714,end: 128.571, sign: "Leo",         meaning: "The Forehead — Regulus nearby, royalty" },
  { number: 11, name: "Al-Zubrah",     start: 128.571,end: 141.429, sign: "Leo",         meaning: "The Mane — the lion's mane, courage" },
  { number: 12, name: "Al-Sarfah",     start: 141.429,end: 154.286, sign: "Leo",         meaning: "The Changer — transformation, weather" },
  { number: 13, name: "Al-Awwa",       start: 154.286,end: 167.143, sign: "Virgo",       meaning: "The Barking Dog — service, analysis" },
  { number: 14, name: "Al-Simak",      start: 167.143,end: 180.0,   sign: "Virgo",       meaning: "The Unarmed — Spica, harvest, abundance" },
  { number: 15, name: "Al-Ghafr",      start: 180.0,  end: 192.857, sign: "Libra",       meaning: "The Cover — balance, protection" },
  { number: 16, name: "Al-Zubana",     start: 192.857,end: 205.714, sign: "Libra",       meaning: "The Claws — justice, weighing" },
  { number: 17, name: "Al-Iklil",      start: 205.714,end: 218.571, sign: "Scorpio",     meaning: "The Crown — the scorpion's crown, leadership" },
  { number: 18, name: "Al-Qalb",       start: 218.571,end: 231.429, sign: "Scorpio",     meaning: "The Heart — Antares, the heart of the scorpion" },
  { number: 19, name: "Al-Shaulah",    start: 231.429,end: 244.286, sign: "Scorpio",     meaning: "The Sting — the scorpion's tail, danger" },
  { number: 20, name: "Al-Naim",       start: 244.286,end: 257.143, sign: "Sagittarius", meaning: "The Ostriches — wisdom, truth-seeking" },
  { number: 21, name: "Al-Baldah",     start: 257.143,end: 270.0,   sign: "Sagittarius", meaning: "The City — the empty place, solitude" },
  { number: 22, name: "Sad al-Dhabih", start: 270.0,  end: 282.857, sign: "Capricorn",   meaning: "The Lucky Stars of the Slaughterer — sacrifice" },
  { number: 23, name: "Sad Bula",      start: 282.857,end: 295.714, sign: "Capricorn",   meaning: "The Lucky Stars of the Swallower — healing" },
  { number: 24, name: "Sad al-Suud",   start: 295.714,end: 308.571, sign: "Aquarius",    meaning: "The Luckiest of the Lucky — good fortune" },
  { number: 25, name: "Sad al-Akhbiya",start: 308.571,end: 321.429, sign: "Aquarius",    meaning: "The Lucky Stars of the Tents — shelter, Fomalhaut nearby" },
  { number: 26, name: "Al-Fargh al-Awwal", start: 321.429, end: 334.286, sign: "Pisces", meaning: "The First Spout — pouring water, flow" },
  { number: 27, name: "Al-Fargh al-Thani", start: 334.286, end: 347.143, sign: "Pisces", meaning: "The Second Spout — completion, cycles" },
  { number: 28, name: "Batn al-Hut",   start: 347.143,end: 360.0,   sign: "Pisces",     meaning: "The Belly of the Fish — the end and the beginning" },
];
 ...
 */
export function getKStarHouse(mapAngle: number): { number: number; sign: string; symbol: string; start: number } {
  const angle = ((mapAngle % 360) + 360) % 360;
 ...
 */
export function calculateAscendant(utcHour: number, utcMinute: number, longitude: number): number {
 ...
 */
export function getHouseFromAscendant(planetAngle: number, ascendant: number): number {
  // Houses count CLOCKWISE from Ascendant
 ...
 */
export function calculateKStarPositions(date: Date, longitude?: number): KStarPlanetPosition[] {
  const daysSinceJ2000 = (date.getTime() - J2000_TIMESTAMP) / (1000 * 60 * 60 * 24);
  ...
  const ascendantPoint: KStarPlanetPosition = {
    ...
    daysSinceJ2000,
    lunarMansion: (() => { const m = getLunarMansion(ascendant); return { number: m.number, name: m.name, meaning: m.meaning }; })(),
  };
  ...
  const descendantPoint: KStarPlanetPosition = {
    ...
    daysSinceJ2000,
    lunarMansion: (() => { const m = getLunarMansion(descendant); return { number: m.number, name: m.name, meaning: m.meaning }; })(),
  };
  ...
  const venusAngle = planetPositions.find(p => p.name === 'Venus')?.mapAngle ?? 0;
  const mercuryAngle = planetPositions.find(p => p.name === 'Mercury')?.mapAngle ?? 0;
  const saturnAngle = planetPositions.find(p => p.name === 'Saturn')?.mapAngle ?? 0;

  const makeLot = (name: string, symbol: string, color: string, angle: number): KStarPlanetPosition => {
    ...
    const mansion = getLunarMansion(mapAngle);
    return {
      name, symbol, color, mapAngle,
      mapRadius: 10 + (house / 12) * 80,
      house, houseName: `House ${house}`,
      sign: zodiacH.sign, signSymbol: zodiacH.symbol,
  ...
  const lotOfFortune = makeLot('Lot of Fortune', '☉☽', '#FFD700',
    ascendant + moonAngle - sunAngle);
  const lotOfSpirit = makeLot('Lot of Spirit', '☉☉', '#FFF8DC',
    ascendant + sunAngle - moonAngle);
  const lotOfKarma = makeLot('Lot of Karma', '☿☽', '#9370DB',
    ascendant + mercuryAngle - moonAngle);
  const lotOfDeath = makeLot('Lot of Death', '☠', '#8B0000',
    ascendant + saturnAngle - moonAngle);
  const lotOfEros = makeLot('Lot of Eros', '♀♀', '#FF69B4',
    ascendant + venusAngle - (ascendant + sunAngle - moonAngle));

  // Add Ascendant, Descendant, Rahu/Ketu, and Lots to the positions
  return [ascendantPoint, descendantPoint, ...planetPositions,
    lotOfFortune, lotOfSpirit, lotOfKarma, lotOfDeath, lotOfEros];
}
...
export function formatKStarPositions(
  ...
  for (const p of planets) {
    const royal = p.royalStarAlignments.length > 0
      ? ` ★ near ${p.royalStarAlignments.join(", ")}`
      : "";
    const signDeg = p.degreeInSign.toFixed(1);
    const mansion = p.lunarMansion ? ` [Mansion ${p.lunarMansion.number}: ${p.lunarMansion.name}]` : "";
    lines.push(`${p.symbol} ${p.name}: ${signDeg}° ${p.sign}, ${p.houseName}${royal}${mansion}`);
  }
  ...
  for (const p of planets) {
    if (p.lunarMansion) {
      lines.push(`${p.symbol} ${p.name} — Mansion ${p.lunarMansion.number}: ${p.lunarMansion.name}`);
  ...
  lines.push(`─────────────────────────────────────────`);
  for (const star of ROYAL_STARS) {
    lines.push(`${star.name} (${star.direction}): ${star.mapAngle}° — ${star.meaning}`);
  }
