...
export function SavedChartManager({ currentPlacements, onLoadChart }: SavedChartManagerProps) {
  ...
  const loadQuery = trpc.charts.load.useQuery({ chartId: 0 }, { enabled: false });
            ...
            >
              {charts.map((chart) => (
                <div
                  ...
                  onMouseEnter={(e) => {
                    (e.currentTarget as HTMLElement).style.background = 'rgba(100,160,220,0.1)';
                  }}
                  onMouseLeave={(e) => {
